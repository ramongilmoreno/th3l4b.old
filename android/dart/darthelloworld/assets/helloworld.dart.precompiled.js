...
["", "helloworld.dart", , Q, {
  ...
  main: function() {
    ...
    t1.DateTime$_now$0();
    P.print(t1.toString$0(0));
    t1 = document.querySelector("#field");
    t2 = new P.DateTime(Date.now(), false);
    t2.DateTime$_now$0();
    t1.textContent = t2.toString$0(0);
    i = 0;
    do {
      ++i;
      a = "* " + i;
      ...
      H.printString(a);
      t1 = "#field" + i;
      document.querySelector(t1).textContent = a;
    } while (i < 3);
  }
},
1],
